...
void Cursor::performAction()
{
	...
	case CURSORMODE::PLACE_SYSTEM: 
			switch(mSystemType)
				{
					case 1:
						mCanvas->addSurface(mPos,"Square",true,1.0); 
						break;
					case 2:
						mCanvas->addSurface(mPos,"Hexagon",true,1.0); 
						break;
					case 3:
						mCanvas->addSurface(mPos,"Triangle",true,1.0); 
						break;
					case 4:
						mCanvas->addSurface(mPos,"Circle",true,1.0); 
						break;
				}
			break; 
